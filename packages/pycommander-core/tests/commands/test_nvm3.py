...
class TestNvm3(unittest.TestCase):
  ...
  def test_nvm3_deletedevice(self):
  ...
  def test_nvm3_writedevice(self):
    commander = MockCommander(serial_number="123456789")
