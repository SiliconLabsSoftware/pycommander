...
class TestAdapter(unittest.TestCase):
  ...
  def test_adapter_drivermode(self):
    commander = MockCommander(serial_number="123456789")
  ...
  def test_adapter_fwupgrade(self):
    commander = MockCommander(serial_number="123456789")
  ...
  def test_adapter_fwupgradecheck(self):
    commander = MockCommander(serial_number="123456789")
